...
const routeSeo: Record<string, SeoDefinition> = {
    ...
    '/compress-pdf': { title: 'Compress PDF Online – PDF by ib', description: 'Check the Compress PDF status at PDF by ib and learn about planned browser-based compression; reliable production compression is not available yet.', index: false },
    ...
    '/ppt-to-pdf': { title: 'PPT to PDF – PDF by ib', description: 'Check the PPT to PDF status at PDF by ib and review current browser-processing limits; reliable production PPTX conversion is not available yet.', index: false },
    '/protect-pdf': { title: 'Protect PDF – PDF by ib', description: 'Check the Protect PDF status at PDF by ib and review password-security guidance; reliable browser-based PDF encryption is not available yet.', index: false },
