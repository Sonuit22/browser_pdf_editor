...
const routeSeo: Record<string, SeoDefinition> = {
    ...
    '/fill-pdf-form': { title: 'Fill PDF Forms Online | PDF by ib', description: 'Fill PDF forms, add text, dates, and checkmarks with PDF by ib using local browser processing that keeps supported documents on your device.', index: true },
