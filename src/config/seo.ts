...
const routeSeo: Record<string, SeoDefinition> = {
    ...
    '/compress-image': { title: 'Compress Image Online – PDF by ib', description: 'Compress JPG, PNG, and WebP images with quality, dimensions, format, and target-size controls using private browser processing from PDF by ib.', index: true },
