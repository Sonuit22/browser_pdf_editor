...
import { Bug, Check, CircleHelp, FileText, Github, Home, Lightbulb, LockKeyhole, Mail, MessageCircle, ScrollText, ShieldCheck, Zap } from 'lucide-react';
import { bugReportEmailLink, contactEmail, featureRequestEmailLink, githubRepositoryUrl, supportEmailLink } from '../config/footerLinks';
