...
export const RightPanel = memo(function RightPanel() {
    ...
    return (
        <aside className="right-panel" aria-label="Future tools panel">
            ...
            {flattenConfirmOpen && <Modal title="Flatten form on export" onClose={() => setFlattenConfirmOpen(false)}><p>Flattening permanently removes form editability from the exported PDF.</p><div className="modal-actions"><Button variant="secondary" type="button" onClick={() => setFlattenConfirmOpen(false)}>Cancel</Button><Button type="button" onClick={() => { setFlattenForms(true); setFlattenConfirmOpen(false); }}>Enable flattening</Button></div></Modal>}
        </aside>
    );
});
