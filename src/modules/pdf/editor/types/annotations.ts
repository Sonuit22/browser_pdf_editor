...
export type AnnotationBase = AnnotationBounds & AnnotationStyle & { id: AnnotationId; pageId: string; type: AnnotationType; zIndex: number; locked?: boolean; createdAt: number; updatedAt: number };
