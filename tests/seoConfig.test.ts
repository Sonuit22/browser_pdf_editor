...
const pagePaths = [
    ...
    '/ppt-to-pdf', '/protect-pdf', '/unlock-pdf', '/translate-pdf', '/fill-pdf-form', '/image-resizer', '/sign-pdf', '/edit-pdf', '/faq', '/privacy', '/terms', '/about',
    '/contact', '/support', '/blog', '/missing',
];

describe('route SEO configuration', () => {
    it.each(['/', '/all-tools', '/merge-pdf', '/split-pdf', '/remove-pages', '/extract-pages', '/organize-pdf', '/jpg-to-pdf', '/pdf-to-jpg', '/protect-pdf', '/unlock-pdf', '/fill-pdf-form', '/image-resizer', '/sign-pdf', '/edit-pdf', '/faq', '/privacy', '/terms', '/about', '/contact'])('provides useful metadata for %s', (path) => {
